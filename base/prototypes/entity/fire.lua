...
data:extend({
  {
    ...
    collision_box = {{-0.72, -1.2 }, {0.72, 1.2}},
    ...
    attack_parameters =
    {
      ...
      lead_target_for_projectile_speed = 1.0, -- Try to lead a little bit, but not overdo it.
...
{
  {
    ...
    particle_horizontal_speed_deviation = 0.025,
