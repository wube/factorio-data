...
local jets_emission =
{
  ...
  pfunctions.make_pod_overlay("podjet_emission", procession_graphic_catalogue.pod_anim_rotation_closed_emission, 1, 170, 370, true,
  {
...
{
  {
    ...
    frames =
    {
      ...
      { timestamp=400, offset = {70, -40}, offset_t = {70, 0} },
  --[[ offset:
      [
        { "timestamp": 0, "offset": { "x":0, "y":0 }, "offset_t" : { "x":0, "y":-30 }},
        { "timestamp": 400, "offset": { "x":70, "y":-40 }, "offset_t" : { "x":70, "y":0 }}
      ]
    ]]--
      { timestamp=0,   offset_rate = 0, offset_rate_t = 0 },
      { timestamp=400, offset_rate = 0, offset_rate_t = 1 },

      { timestamp=150, tilt = 0  },
      { timestamp=180, tilt = 0 , tilt_t = 0.03  },
      { timestamp=199, tilt = 0.1 , tilt_t = -0.04  },
      { timestamp=250, tilt = 0.11 , tilt_t = 0.03  },
      { timestamp=302, tilt = 0.25 , tilt_t = -0.05  },
      { timestamp=382, tilt = 0.25 , tilt_t = 0.0  }
    --[[
        [
          { "timestamp": 150, "tilt": { "x":0 }, "tilt_t" : { "x":0 }},
          { "timestamp": 180, "tilt": { "x":0 }, "tilt_t" : { "x":0.03 }},
          { "timestamp": 199, "tilt": { "x":0.1 }, "tilt_t" : { "x":-0.04 }},
          { "timestamp": 250, "tilt": { "x":0.11 }, "tilt_t" : { "x":0.03 }},
          { "timestamp": 302, "tilt": { "x":0.25 }, "tilt_t" : { "x":-0.05 }},
          { "timestamp": 382, "tilt": { "x":0.25 }, "tilt_t" : { "x":0.01 }}
        ]
     ]]--
    }
  },
  {
    ...
    frames =
    {
      ...
      { timestamp = 350, outside_opacity = 0 },
  ...
  pfunctions.make_pod_animation("a_open_rotation", procession_graphic_catalogue.pod_anim_rotation_closed, 171, 0,
  {
    { timestamp=171, frame = 0 },
